...
void CShotgun::SecondaryAttack(void)
{
	...
	vecDir = m_pPlayer->FireBulletsPlayer(8, vecSrc, vecAiming, GetSpreadVector( SecondaryWeaponSpread() ), 2048, BULLET_PLAYER_BUCKSHOT, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed);
