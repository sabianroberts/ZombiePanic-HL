    ...
    : BaseClass(parent, "CModelSubOptions")
{
	...
	m_pEnemyModels->AddColumnHeader(0, "ModelName", "#ZP_AdvOptions_Models_ModelName", 1024, 0, 1024, vgui2::ListPanel::COLUMN_RESIZEWITHWINDOW);
	m_pEnemyModels->SetColumnSortable(0, false);
	m_pEnemyModels->SetIgnoreDoubleClick(true);

	m_pAddEnemyModel = new vgui2::Button(this, "AddEnemyModel", "#ZP_AdvOptions_Models_Add", this, "AddEnemyModel");
	m_pRemoveEnemyModel = new vgui2::Button(this, "RemoveEnemyModel", "#ZP_AdvOptions_Models_Remove", this, "RemoveEnemyModel");
	m_pRemoveAllEnemyModels = new vgui2::Button(this, "RemoveAllEnemyModels", "#ZP_AdvOptions_Models_RemoveAll", this, "RemoveAllEnemyModels");
	...
	m_pHideCorpses = new CCvarCheckButton(this, "HideCorpses", "#ZP_AdvOptions_Models_HideCorpses", "cl_hidecorpses");
	m_pLeftHand = new CCvarCheckButton(this, "LeftHand", "#ZP_AdvOptions_Models_LeftHand", "cl_righthand");
	m_pAngledBob = new CCvarCheckButton(this, "AngledBob", "#ZP_AdvOptions_Models_AngledBob", "cl_bob_angled");
	m_pNoShells = new CCvarCheckButton(this, "NoShells", "#ZP_AdvOptions_Models_NoShells", "cl_noshells");
	m_pNoViewModel = new CCvarCheckButton(this, "NoViewModel", "#ZP_AdvOptions_Models_NoViewmodel", "r_drawviewmodel", true);
