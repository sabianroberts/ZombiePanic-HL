    ...
    : BaseClass(parent, "GeneralSubOptions")
{
	...
	m_pAutoJump = new CCvarCheckButton(this, "AutoJump", "#ZP_AdvOptions_General_AutoJump", "cl_autojump");
	m_pAutoJumpLabel = new vgui2::Label(this, "AutoJumpLabel", "#ZP_AdvOptions_General_AutoJump2");
