...
public:
	...
	{
		SetTitle("#ZP_AdvOptions_About_OSSCredits", true);
		SetSize(640, 480);
    ...
    : BaseClass(parent, "AboutSubOptions")
{
	...
	m_pBHLLabel = new vgui2::Label(this, "BHLLabel", "#ZP_AdvOptions_About_BHL");
...
#if USE_UPDATER
	m_pAutoCheck = new CCvarCheckButton(this, "AutoCheck", "#ZP_AdvOptions_About_AutoCheck", "cl_check_for_updates");
...
void CAboutSubOptions::UpdateControls()
{
	...
	{
		m_pLatestVerLabel->SetText("#ZP_AdvOptions_About_Unknown");
		m_pUpdateLabel->SetVisible(false);
	}
#endif
}
