...
ConVar hud_speedometer("hud_speedometer", "0", 0, "Enable speedometer");
ConVar hud_speedometer_below_cross("hud_speedometer_below_cross", "0", 0, "Move speedometer to below the crosshair");
